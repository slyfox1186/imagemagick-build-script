...
# that is plainly not a browser: gitlab.gnome.org's CDN answers every cache miss
# with an empty HTTP 406, and gitlab.freedesktop.org serves its Anubis HTML
# challenge with HTTP 200. Sources hosted there must be cloned instead.
...
class DownloadSettings:
    ...
    def __init__(self, environment: dict[str, str] | None = None) -> None:
        ...
        self.connect_timeout = positive("DOWNLOAD_CONNECT_TIMEOUT", 15)
